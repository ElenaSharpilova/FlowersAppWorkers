...
import android.example.flowerschemistryworkers.ui.fragments.MyBouquetFragment
...
class MyBouquetAdapter(val clickListener: OnItemClickLestenerMyBouquets):
    RecyclerView.Adapter<MyBouquetAdapter.ViewHolder>(){
